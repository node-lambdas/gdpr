...
<style>@media(min-width:640px){#u4yrtkjyt6i5uy{max-width:50vw}}</style>
<script>localStorage.__gdpr_dismiss || (document.getElementById('u4yrtkjyt6i5uy').style.display='block');</script>`;
}
export default {
  version: 2,
  actions: {
